...
//GROUP PROJECT SODV2202
//Arianne Guedes, Dario Ospina, Jorge Gayer and Robert Parker
...
namespace Yahtzee
{
    public partial class frmMain : Form
    {
        ...
        private int CountMoves { get; set; } //used to keep track of how many roles each user has had in a turn.
        ...
        private void btnRollDice_Click(object sender, EventArgs e)
        {
            ...
            CountMoves++;
            scoreBoard.RollDice();
            if (CountMoves==1) //prevents dice from bring held before the players first role
            {
                EnableDice();
            }
            ...
            {
                //Enable all of the points labels, depending on which player's turn it is
                //calculate the available scores based on the rolled dice, and populate the labels with values
                ...
                //show the rolled die numbers to the player
        ...
        //When a score is selected, Stop the turn and add the score to the player's total
        private void lblP1One_Click(object sender, EventArgs e)
        {
            scoreBoard.HoldGame(GamesCombination.Ones); //this will make sure that the selected score, will not be clickable on the next round
            Label label = (Label)sender;
            UpdateTotal(label);
        }
        ...
        //When a score is selected, highlight it and disable it from being selected again.
        ...
        //set the board ready for the next player's turn.
        ...
        //display the winner and the restart button
        ...
        //on click will prevent a die from being rolled and display it to the user
        ...
        //reset the game ready for two new players
